        ...
        <div className='py-2'>
            <div className='px-2 h-full bg-gray-100 rounded-xl dark:bg-gray-800'>
                <div className='flex items-center justify-between'>
                    <div className=' dark:text-white text-[1.2rem] font-semibold capitalize'>{reporttype} Report</div>
                    <div className='pt-2'>
                        ...
                        loading ? Array.from({ length: 4 }).map((_, index) => (
                            ...
                            card?.map((item, ind) => (
                                <div key={ind} className='p-4 rounded-lg bg-white dark:bg-gray-700 col-span-6 lg:col-span-4 xl:col-span-3'>
                                    ...
                                    <div className={`text-3xl lg:text-5xl text-transparent bg-clip-text bg-gradient-to-tr from-[#F08D36] to-[#FFD117] pt-4 ${item?.title === 'Date' && 'text-[1.4rem] lg:text-[2rem]'}`}>{item?.amount}</div>
                                </div>
                            ))
                    }
                </div>
                ...
                <div className='pt-5 pb-3 grid grid-cols-12 gap-4 h-full'>
                    ...
                    <div className='col-span-12 lg:col-span-5 p-3 rounded-lg  bg-white dark:bg-gray-700 '>
                        <div className='text-[1.2rem]  dark:text-white'>Most Played Games</div>
